const sentenceData = getPastSentences();
...
const closeExplanationModal = document.getElementById(
  'close-explanation-modal'
);
const closeExplanationModalEnd = document.getElementById(
  'close-explanation-modal-end'
);
